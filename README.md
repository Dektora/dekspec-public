...
```bash
pipx install "git+https://github.com/Dektora/dekspec-public.git@v0.109.0"
```

CLI only into a project venv:
```bash
pip install "git+https://github.com/Dektora/dekspec-public.git@v0.109.0"
```
