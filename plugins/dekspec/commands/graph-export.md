---
description: Run `dekspec dev graph export` — emit the DekSpec artifact dependency graph as text / JSON / DOT / Mermaid for visualization or external tooling.
...
3. Run `dekspec dev graph export $ARGUMENTS` via Bash.
4. On success:
