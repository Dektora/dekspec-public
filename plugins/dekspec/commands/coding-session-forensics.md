...
2. Relay the skill's output to the operator. The skill is read-only: it gathers
   ...
   `docs/workspace/<area>/pm/coding-session-forensics/` (or `.dekspec-coding-session-forensics/` as fallback) —
