...
- [ ] `dekspec validate <output-path>` exited 0 and `dekspec doctor --at .` was re-run post-write by the orchestrator.
...
- [ ] `dekspec relink` ran against the repo root as the final action.
